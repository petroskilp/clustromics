...
annotated$symbol <- ifelse(annotated$external_gene_name == '', annotated$gene, annotated$external_gene_name)
annotated$external_gene_name <- NULL
annotated <- annotated[, c("symbol", setdiff(names(annotated), "symbol"))]
